...
public class Franja {
	...
	/**
	 * Método para agregar la franja al grupo de franjas, en él se comprueba si las
	...
	/**
	 * Método para comprobar que el día tenga el espacio suficiente para la franja
